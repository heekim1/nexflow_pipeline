...
OUTPUT_DIR=$(realpath ./output_demux_10k_params)
mkdir -p $OUTPUT_DIR
...
--runFastq "/sc1/groups/onco/Analysis/bioinfo_analyses/kimh89/SBX/bfx-ngs-AVC-225/pipeline/examples/SC1/run.fastq.10k.fastq" \
